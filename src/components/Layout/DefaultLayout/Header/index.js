      ...
      <header className={wrapperClasses}>
         ...
         <div className={cx('grid')}>
            <div className={cx('header__navbar')}>
               ...
               <ul className={cx('header__navbar-list')}>
                  <li className={cx('header__navbar-item')}>
                     <HiBars3 className={cx('header__navbar-bars')} />
                  </li>
                  <li className={cx('header__navbar-item')}>
                     <a href="/" className={cx('header__navbar-item-link', 'header__navbar-home-page')}>
                        TRANG CHỦ
                     </a>
                  </li>
                  <li
               ...
               <ul className={cx('navbar-mobile-list')}>
                  ...
                  <li className={cx('navbar-mobile-item', 'header__navbar-item-has-cart')}>
                     {/* eslint-disable-next-line */}
                     <a href="" className={cx('navbar-mobile-item-link')}>
